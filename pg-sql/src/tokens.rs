...
pub mod literal {
    ...
    const SQL_KEYWORDS: &[&str] = &[
        ...
        "DROP", "DELETE", "ORDER", "BY", "BOOL", "BOOLEAN", "TEXT", "INT",
        "SERIAL", "PRIMARY", "KEY", "ASC", "DESC", "NULLS", "FIRST", "LAST",
        "USING", "OFFSET", "LIMIT", "ANALYZE", "SET", "RESET", "TO", "ON",
        "OFF", "TEMP", "INDEX", "EXPLAIN", "FOR", "UPDATE", "FUNCTION",
        "RETURNS", "SETOF", "LANGUAGE", "IMMUTABLE", "UNION", "ALL", "IN",
        "DEFAULT", "LATERAL", "PARTITION", "OF", "COSTS", "TIMING", "SUMMARY",
        // New keywords for WITH support
        "WITH", "RECURSIVE", "MATERIALIZED", "EXCEPT", "INTERSECT", "DISTINCT",
        "JOIN", "LEFT", "RIGHT", "FULL", "INNER", "CROSS", "GROUP", "HAVING",
        "RETURNING", "MERGE", "WHEN", "MATCHED", "THEN", "CONFLICT", "DO",
        "NOTHING", "EXCLUDED", "VIEW", "REPLACE", "TEMPORARY", "EXISTS",
        "SEARCH", "DEPTH", "BREADTH", "CYCLE", "ARRAY", "ROW", "OVER",
        "INTEGER", "NUMERIC", "VARCHAR", "ALTER", "ADD", "UNIQUE", "RULE",
        "TRIGGER", "BEFORE", "AFTER", "EACH", "STATEMENT", "EXECUTE",
        "PROCEDURE", "INSTEAD", "ALSO", "NEW", "OLD", "BEGIN", "COMMIT",
        "TRUNCATE", "NOTIFY", "INHERITS", "REFERENCES", "GENERATED", "ALWAYS",
        "IDENTITY", "LOCAL", "ANY", "BETWEEN", "LIKE", "CASE", "ELSE", "END",
        "VERBOSE",
    ];
